...
class BackendStub(object):
    ...
    def __init__(self, channel):
        ...
        self.predict = channel.unary_unary(
                '/Backend/predict',
                request_serializer=backend__pb2.img_predic_ruta.SerializeToString,
                response_deserializer=backend__pb2.prediction_result.FromString,
                )
...
def add_BackendServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'predict': grpc.unary_unary_rpc_method_handler(
                    servicer.predict,
                    request_deserializer=backend__pb2.img_predic_ruta.FromString,
                    response_serializer=backend__pb2.prediction_result.SerializeToString,
            ),
    }
...
class Backend(object):
    ...
    def predict(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Backend/predict',
            backend__pb2.img_predic_ruta.SerializeToString,
            backend__pb2.prediction_result.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
